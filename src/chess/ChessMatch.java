...
public class ChessMatch {
    ...
    private Piece makeMove(Position source, Position target){
        ChessPiece p = (ChessPiece)board.removePiece(source); // tiro a peca de origem do lugar inicial
        p.increaseMoveCount();
        ...
        ////SPECIAL MOVE - Castling (Roque) - lado do rei(curto)
        ...
        ////SPECIAL MOVE - Castling (Roque) - lado da rainha(longo)
        if(p instanceof King && target.getColumn() == source.getColumn() - 2){
